...
class CanalTestCase(TestCase):
    def setUp(self):
        self.usuario_a = User.objects.create(username='facundo', password='12345')
        self.usuario_b = User.objects.create(username='lautaro', password='54321')
        self.usuario_c = User.objects.create(username='franco', password='88888')
